    ...
    <section className="ac-hero" aria-labelledby="what-is-h2" style={style}>
      <div className="ac-hero__grid">
        <div className="ac-hero__copy">
          ...
          {(edit || mediaUrl(hero.sectionImage) || (hero.sectionVideoUrl ?? "").trim()) && (
            // In-copy media block. zIndex in edit mode keeps the MediaSlot
            // popover above the following text blocks (Reveal creates stacking
            // contexts that would otherwise paint over it).
            <div
              style={{
                position: "relative",
